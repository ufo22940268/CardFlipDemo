...
public class CardFlipActivity extends Activity
    ...
    private int mImage1Index;
    private int mImage2Index;
    private int[] mImage1Animators = {
            R.animator.card_flip_right_out,
            R.animator.card_flip_left_in
    };

    private int[] mImage2Animators = {
    ...
    private void toggleImage2() {
        ...
        Animator animator2 = AnimatorInflater.loadAnimator(this, mImage2Animators[mImage2Index]);
        animator2.setTarget(mImage2);
        animator2.start();
        mImage2Index = (mImage2Index + 1) % 2;
    }

    private void toggleImage1() {
        Animator animator = AnimatorInflater.loadAnimator(this, mImage1Animators[mImage1Index]);
        animator.setTarget(mImage1);
        animator.start();
        mImage1Index = (mImage1Index + 1) % 2;
    }
